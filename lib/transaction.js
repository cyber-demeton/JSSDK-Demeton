 ...
 *
 * @see [Create own smart contract in Demeton.]{@link https://github.com/cyber-demeton/wiki/blob/master/tutorials/%5BEnglish%5D%20Demeton%20101%20-%2003%20Smart%20Contracts%20JavaScript.md}
 * @see [More about transaction parameters.]{@link https://github.com/cyber-demeton/wiki/blob/c3f5ce8908c80e9104e3b512a7fdfd75f16ac38c/rpc.md#sendtransaction}
 *
 * @example
 * // It's example of possible fields values.
 * // For deploy, and execute smart contracts follow this link - https://github.com/cyber-demeton/wiki/blob/master/tutorials/%5BEnglish%5D%20Demeton%20101%20-%2003%20Smart%20Contracts%20JavaScript.md
 * {
 ...
 */
  ...
  * @property {Number} options.gasPrice - Gas price. The unit is 10^-4 DEMT.
 ...
 * @see [For more information about parameters, follow this link]{@link https://github.com/cyber-demeton/wiki/blob/master/rpc.md#sendrawtransaction}
 * @constructor
 *
 * @param {TransactionOptions} options - Transaction options.
 *
 * @see [Transaction tutorial.]{@link https://github.com/cyber-demeton/wiki/blob/master/tutorials/%5BEnglish%5D%20Demeton%20101%20-%2002%20Transaction.md}
 * @see [Create own smart contract in Demeton.]{@link https://github.com/cyber-demeton/wiki/blob/master/tutorials/%5BEnglish%5D%20Demeton%20101%20-%2003%20Smart%20Contracts%20JavaScript.md}
 * @see [More about transaction parameters.]{@link https://github.com/cyber-demeton/wiki/blob/c3f5ce8908c80e9104e3b512a7fdfd75f16ac38c/rpc.md#sendtransaction}
 *
 * @example
...
var Transaction = function (options) {
    if (arguments.length > 0) {
        ...
        if(!this.value.isInteger())
            throw new Error("Invalid value! The minimum unit is wei (1^-4 demt)");
...
Transaction.prototype = {
     ...
     * // {chainID: 1001, from: "n1USdDKeZXQYubA44W2ZVUdW1cjiJuqswxp", to: "n1SAeQRVn33bamxN4ehWUT7JGdxipwn8b17", value: 100000, nonce: 1, …}
     */
