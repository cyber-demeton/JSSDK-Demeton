 ...
 * @see [Admin API documentation:]{@link https://github.com/cyber-demeton/wiki/blob/master/rpc_admin.md}.
 * @constructor
 *
 * @param {Deb} deb - Instance of Deb library.
 *
 * @example
 * var admin = new Admin( new Deb() );
 * // or just
 * var admin = new Deb().admin;
 */
var Admin = function (deb) {
...
/**
 * Method get info about nodes in Demeton Network.
 * @see {@link https://github.com/cyber-demeton/wiki/blob/master/rpc_admin.md#nodeinfo}
 *
 * @return [nodeInfoObject]{@link https://github.com/cyber-demeton/wiki/blob/master/rpc_admin.md#nodeinfo}
 *
 * @example
 * var admin = new Deb().admin;
 ...
 * @see {@link https://github.com/cyber-demeton/wiki/blob/master/rpc_admin.md#accounts}
 *
 * @return [accountsList]{@link https://github.com/cyber-demeton/wiki/blob/master/rpc_admin.md#accounts}
 *
 * @example
 * var admin = new Deb().admin;
...
/**
 * Method create a new account in Demeton network with provided passphrase.
 * @see {@link https://github.com/cyber-demeton/wiki/blob/master/rpc_admin.md#newaccount}
 *
 * @param {Object} options
 * @param {Password} options.passphrase
 *
 * @return [address]{@link https://github.com/cyber-demeton/wiki/blob/master/rpc_admin.md#newaccount}
 *
 * @example
 * var admin = new Deb().admin;
 ...
 * @see {@link https://github.com/cyber-demeton/wiki/blob/master/rpc_admin.md#unlockaccount}
 *
 * @param {Object} options
 ...
 *
 * @return [isUnLocked]{@link https://github.com/cyber-demeton/wiki/blob/master/rpc_admin.md#unlockaccount}
 *
 * @example
 * var admin = new Deb().admin;
 * admin.unlockAccount({
...
/**
 * Method lock account.
 * @see {@link https://github.com/cyber-demeton/wiki/blob/master/rpc_admin.md#lockaccount}
 *
 * @param {Object} options
 * @param {HexString} options.address
 *
 * @return [isLocked]{@link https://github.com/cyber-demeton/wiki/blob/master/rpc_admin.md#lockaccount}
 *
 * @example
 * var admin = new Deb().admin;
 ...
 * @see {@link https://github.com/cyber-demeton/wiki/blob/master/rpc_admin.md#sendtransaction}
 *
 * @param {TransactionOptions} options
 *
 * @return [Transcation hash and contract address]{@link https://github.com/cyber-demeton/wiki/blob/master/rpc_admin.md#sendtransaction}
 *
 * @example
 * var admin = new Deb().admin;
...
/**
 * Method sign hash.
 * @see {@link https://github.com/cyber-demeton/wiki/blob/master/rpc_admin.md#signhash}
 *
 * @param {Object} options
 * @param {HexString} options.address
 ...
 *
 * @return [data]{@link https://github.com/cyber-demeton/wiki/blob/master/rpc_admin.md#signhash}
 *
 * @example
 * var admin = new Deb().admin;
 * admin.SignHash({
 ...
 * @see {@link https://github.com/cyber-demeton/wiki/blob/master/rpc_admin.md#signtransactionwithpassphrase}
 *
 * @param {TransactionOptions} options
 * @param {Password} options.passphrase
 *
 * @return [Transcation hash and contract address]{@link https://github.com/cyber-demeton/wiki/blob/master/rpc_admin.md#signtransactionwithpassphrase}
 *
 * @example
 * var admin = new Deb().admin;
 ...
 * @see {@link https://github.com/cyber-demeton/wiki/blob/master/rpc_admin.md#sendtransactionwithpassphrase}
 *
 * @param {TransactionOptions} options
 * @param {Password} options.passphrase
 *
 * @return [data]{@link https://github.com/cyber-demeton/wiki/blob/master/rpc_admin.md#sendtransactionwithpassphrase}
 *
 * @example
 * var admin = new Deb().admin;
 ...
 * @see {@link https://github.com/cyber-demeton/wiki/blob/master/rpc_admin.md#startpprof}
 *
 * @param {Object} options
 * @param {String} options.listen - Listen port.
 *
 * @return [isListenStrted]{@link https://github.com/cyber-demeton/wiki/blob/master/rpc_admin.md#startpprof}
 *
 * @example
 * var admin = new Deb().admin;
...
/**
 * Method get config of node in Demeton Network.
 * @see {@link https://github.com/cyber-demeton/wiki/blob/master/rpc_admin.md#getConfig}
 *
 * @return [config]{@link https://github.com/cyber-demeton/wiki/blob/master/rpc_admin.md#getConfig}
 *
 * @example
 * var admin = new Deb().admin;
