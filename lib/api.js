 ...
 *
 * @see [API documentation]{@link https://github.com/cyber-demeton/wiki/blob/master/rpc.md}
 * @constructor
 *
 * @param {Deb} deb - Instance of Deb library.
 *
 * @example
 * var api = new API ( new Deb() );
 * // or just
 * var api = new Deb().api;
 */
var API = function (deb) {
    this._setRequest(deb._request);
};
...
/**
 * Method get state of Demeton Network.
 * @see {@link https://github.com/cyber-demeton/wiki/blob/master/rpc.md#getdebstate}
 *
 * @return [NebStateObject]{@link https://github.com/cyber-demeton/wiki/blob/master/rpc.md#getdebstate}
 *
 * @example
 * var api = new Deb().api;
 * api.getDebState().then(function(state) {
 * //code
 * });
 */
API.prototype.getDebState = function () {
    return this._sendRequest("get", "/debstate", null);
};

/**
 * Method get latest irreversible block of Demeton Network.
 * @see {@link https://github.com/cyber-demeton/wiki/blob/master/rpc.md#latestirreversibleblock}
 *
 * @return [dataBlockInfo.]{@link https://github.com/cyber-demeton/wiki/blob/master/rpc.md#latestirreversibleblock}
 *
 * @example
 * var api = new Deb().api;
 ...
 * @see {@link https://github.com/cyber-demeton/wiki/blob/master/rpc.md#getaccountstate}
 *
 * @param {Object} options
 * @param {HexString} options.address
 * @param {String} options.height
 *
 * @return [accaountStateObject]{@link https://github.com/cyber-demeton/wiki/blob/master/rpc.md#getaccountstate}
 *
 * @example
 * var api = new Deb().api;
 ...
 * @see {@link https://github.com/cyber-demeton/wiki/blob/master/rpc.md#call}
 *
 * @param {TransactionOptions} options
 *
 * @return [Transcation hash]{@link https://github.com/cyber-demeton/wiki/blob/master/rpc.md#call}
 *
 * @example
 * var api = new Deb().api;
 * api.call({
 ...
 * @see {@link https://github.com/cyber-demeton/wiki/blob/master/rpc.md#sendrawtransaction}
 *
 * @param {Object} options
 * @param {String} options.data
 *
 * @return [Transcation hash]{@link https://github.com/cyber-demeton/wiki/blob/master/rpc.md#sendrawtransaction}
 *
 * @example
 * var api = new Deb().api;
 ...
 * @see {@link https://github.com/cyber-demeton/wiki/blob/master/rpc.md#getblockbyhash}
 *
 * @param {Object} options
 * @param {HexString} options.hash
 * @param {Boolean} options.fullTransaction
 *
 * @return [Block]{@link https://github.com/cyber-demeton/wiki/blob/master/rpc.md#getblockbyhash}
 *
 * @example
 * var api = new Deb().api;
 * api.getBlockByHash({
 ...
 * @see {@link https://github.com/cyber-demeton/wiki/blob/master/rpc.md#getblockbyheight}
 *
 * @param {Object} options
 * @param {Number} options.height
 * @param {Boolean} options.fullTransaction
 *
 * @return [Block]{@link https://github.com/cyber-demeton/wiki/blob/master/rpc.md#getblockbyheight}
 *
 * @example
 * var api = new Deb().api;
 ...
 * @see {@link https://github.com/cyber-demeton/wiki/blob/master/rpc.md#gettransactionreceipt}
 *
 * @param {Object} options
 * @param {HexString} options.hash
 *
 * @return [TransactionReceipt]{@link https://github.com/cyber-demeton/wiki/blob/master/rpc.md#gettransactionreceipt}
 *
 * @example
 * var api = new Deb().api;
 ...
 * @see {@link https://github.com/cyber-demeton/wiki/blob/master/rpc.md#gettransactionbycontract}
 *
 * @param {Object} options
 * @param {HexString} options.address contract address
 *
 * @returns the same as [TransactionReceipt]{@link https://github.com/cyber-demeton/wiki/blob/master/rpc.md#gettransactionreceipt}
 *
 * @example
 * var api = new Deb().api;
 ...
 * @see {@link https://github.com/cyber-demeton/wiki/blob/master/rpc.md#subscribe}
 *
 * @param {Object} options
 * @param {Array|String} options.topics
 * @param {Function} options.onDownloadProgress - On progress callback function. Recive chunk.
 *
 * @return [eventData]{@link https://github.com/cyber-demeton/wiki/blob/master/rpc.md#subscribe}
 *
 * @example
 * var api = new Deb().api;
 ...
 * @see {@link https://github.com/cyber-demeton/wiki/blob/master/rpc.md#getgasprice}
 *
 * @return [Gas Price]{@link https://github.com/cyber-demeton/wiki/blob/master/rpc.md#getgasprice}
 *
 * @example
 * var api = new Deb().api;
 ...
 * @see {@link https://github.com/cyber-demeton/wiki/blob/master/rpc.md#estimategas}
 *
 * @param {TransactionOptions} options
 *
 * @return [Gas]{@link https://github.com/cyber-demeton/wiki/blob/master/rpc.md#estimategas}
 *
 * @example
 * var api = new Deb().api;
 * api.estimateGas({
 ...
 * @see {@link https://github.com/cyber-demeton/wiki/blob/master/rpc.md#geteventsbyhash}
 *
 * @param {Object} options
 * @param {HexString} options.hash
 *
 * @return [Events]{@link https://github.com/cyber-demeton/wiki/blob/master/rpc.md#geteventsbyhash}
 *
 * @example
 * var api = new Deb().api;
 ...
 * @see {@link https://github.com/cyber-demeton/wiki/blob/master/rpc.md#getdynasty}
 *
 * @param {Object} options
 * @param {Number} options.height
 *
 * @return [delegatees]{@link https://github.com/cyber-demeton/wiki/blob/master/rpc.md#getdynasty}
 *
 * @example
 * var api = new Deb().api;
